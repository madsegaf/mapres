		...
		else
		{
			$this->base_url = rtrim($this->base_url, '/') .'/';
		            ...
		            $foout="";
								...
								// $foout .="<br>";
		            if($this->cur_page==1) {
		                $foout .='<a href="#">Previous</a>&nbsp;';
		            } else {
		                $i = $this->cur_page-1;
		                $foout .= '<a href="'.$this->base_url.$i.'">Previous</a>&nbsp;';
		            }

		            if($start > 1) {
		                $foout .= '<a href="'.$this->base_url.'1">1</a>&nbsp;';
		                if ($start > 2) {
		            ...
		            for ($i = $start; $i <= $end && $i <= $num_pages; $i++){
		                if($i==$this->cur_page) {
		                    ...
		                    $foout .='<a href="'.$this->base_url.$i.'" >'.$i.'</a>&nbsp;';
		                }
		            }
		            ...
		            if($this->cur_page < $num_pages) {
		                $i = $this->cur_page+1;
		                //$foout .='<span class="prn">...</span>&nbsp;';
		                $foout .='<a href="'.$this->base_url.$this->prefix.$i.$this->suffix.'">Next</a>';
		            } else {
		                $foout .='<a href="#">Next</a>';
		            }
